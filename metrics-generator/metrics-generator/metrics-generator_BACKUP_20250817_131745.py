    ...
    if cmd == "simplemetric1":
        ...
        while datetime.now() < timeoutTime:
            if datetime.now() > sendMetricTime:
                logger.info("🌌 Now: {} samplesSent: {}".format(datetime.now(), samplesSent))
        ...
        while datetime.now() < timeoutTime:
            if datetime.now() > sendMetricTime:
                logger.info("🌌 Now: {} statusDataOffset: {}".format(datetime.now(), statusDataOffset))
                #sendMetricTime = now + timedelta(seconds=delaySec)
                nowdt = datetime.utcnow()
        ...
        print( "Commands are:")
        logger.info("🌌   regionalServices <number of regions> <number of services> <run time seconds> <rate per minute> [debug]")
        logger.info("🌌   histogram1 - generate a classic histogram")
